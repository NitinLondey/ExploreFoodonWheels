	...
	<div class="bg-2 section" id="contact">
		<div class="inner" data-topspace="45" data-bottomspace="35"
			...
			<div class="container">
				...
				<h3 class="hdr1">Menu Card</h3>

				<div class="easyBox full">


					<c:forEach var="menu" items="${listofmenu}">
						<div class="row nomargin">
							<div class="col-md-8">
								...
								<div class="frameImg">
									<c:choose>
										<c:when test="${menu.image_path == null}">
											<img
										...
										<c:otherwise>
											<img
												src="${pageContext.request.contextPath}/uploads/${menu.image_path}"
												alt=" ">
										</c:otherwise>
									</c:choose>
								</div>
