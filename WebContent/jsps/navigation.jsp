		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<div class="text-center">
					<p class="address">Tacos Locos - Atlantic Avenue 1234, New
						York, +66 87 65 43 21</p>
				</div>
				...
				<ul class="smallSocials">
					<li class="fb"><a href="#"><img
							src="${pageContext.request.contextPath}/images/smallsocial-fb.png"
							alt="Facebook"></a></li>
					<li class="tw"><a href="#"><img
							src="${pageContext.request.contextPath}/images/smallsocial-tw.png"
							alt="Twitter"></a></li>
					<li class="gg"><a href="#"><img
							src="${pageContext.request.contextPath}/images/smallsocial-gg.png"
							alt="Google+"></a></li>
					<li class="rss"><a href="#"><img
							src="${pageContext.request.contextPath}/images/smallsocial-rss.png"
							alt="RSS"></a></li>
				</ul>
			</div>
