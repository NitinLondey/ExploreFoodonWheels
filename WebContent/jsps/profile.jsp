  ...
  <div class="inner" data-topspace="45" data-bottomspace="35" data-image="assets/flavours/tacos/images/demo-content/background-6.jpg">
    ...
    <div class="container">
      ...
      <div class="easyBox full">
        ...
        <h4 class="hdr5"><span>User</span></h4>
		<form class="simpleForm" action="${pageContext.request.contextPath}/EditProfileServlet.do" method="post">
           <fieldset>
        <div class="row nomargin">
          <div class="col-md-5">
            <h4 class="hdr2 special">User Information</h4>
                ...
                <div class="form-group">
                  ...
                  <input type="text" required class="form-control" name="address1" value="${user.address_line1 }" placeholder="enter your  address 1">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>City</label>
                  <input type="text" required class="form-control" name="city" value="${user.city }" placeholder="enter your  city">
                </div>
          ...
          <div class="col-md-5">
                ...
                <div class="form-group">
                  <label>State</label>
                  <input type="text" required class="form-control" name="state"  value="${user.state }" placeholder="enter your state">
                </div>
                 <div class="form-group">
                  <label>Zipcode</label>
                  <input type="text" required class="form-control" name="zipcode" value="${user.zipcode }" placeholder="enter your Zipcode">
                </div>
                <div class="form-group">
                  <label>Phone</label>
            ...
            <input class="btn btn-default" type="submit" value="Save change">
          </div>
        </div>
        </fieldset>
       </form>
